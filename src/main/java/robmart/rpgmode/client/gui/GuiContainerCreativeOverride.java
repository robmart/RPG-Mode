...
public class GuiContainerCreativeOverride extends InventoryEffectRenderer {
    ...
    public GuiContainerCreativeOverride(EntityPlayer player) {
        super(new GuiContainerCreativeOverride.ContainerCreative(player));
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        if (creativetabs.shouldHidePlayerInventory()) {
            this.drawTexturedModalRect(
                    i, j + (int) ((float) (k - j - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12),
                    0, 12, 15);
        }
        ...
        if (creativetabs == CreativeTabs.INVENTORY) {
            GuiInventory
                    .drawEntityOnScreen(this.guiLeft + 88, this.guiTop + 45, 20, (float) (this.guiLeft + 88 - mouseX),
                                        (float) (this.guiTop + 45 - 30 - mouseY), this.mc.player);
        }
    }
            ...
            if (slotIn == this.destroyItemSlot && flag) {
                ...
                if (slotIn == this.destroyItemSlot) {
                    ...
                    this.mc.playerController.sendSlotPacket(
                            itemstack1,
                            ((GuiContainerCreativeOverride.CreativeSlot) slotIn).slot.slotNumber);
                }
                    ...
                    this.mc.player.inventoryContainer.slotClick(
                            slotIn == null ? slotId :
                            ((GuiContainerCreativeOverride.CreativeSlot) slotIn).slot.slotNumber, mouseButton, type,
                            this.mc.player);
                ...
                if (!itemstack5.isEmpty() && !itemstack7.isEmpty() && itemstack5.isItemEqual(itemstack7) &&
                ...
                if (Container.getDragEvent(mouseButton) == 2) {
                    ...
                    this.mc.playerController.sendSlotPacket(itemstack4, slotIn.slotNumber -
                                                                        this.inventorySlots.inventorySlots.size() + 9 +
                                                                        36);
        ...
        if (tab.hasSearchBar() && tab != CreativeTabs.SEARCH) {
            ...
            if (!this.searchField.getText().isEmpty()) {
                ...
                while (itr.hasNext()) {
                    ...
                    for (String line : stack.getTooltip(this.mc.player, this.mc.gameSettings.advancedItemTooltips ?
                                                                        ITooltipFlag.TooltipFlags.ADVANCED :
                                                                        ITooltipFlag.TooltipFlags.NORMAL)) {
                        if (TextFormatting.getTextWithoutFormattingCodes(line).toLowerCase(Locale.ROOT)
                                          .contains(search)) {
                            matches = true;
                            break;
                        }
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.isScrolling) {
            ...
            ((GuiContainerCreativeOverride.ContainerCreative) this.inventorySlots).scrollTo(this.currentScroll);
        }
    ...
    protected void renderToolTip(ItemStack stack, int x, int y) {
        if (selectedTabIndex == CreativeTabs.SEARCH.getTabIndex()) {
            ...
            if (creativetabs != null) {
                list.add(
                        1, "" + TextFormatting.BOLD + TextFormatting.BLUE +
    ...
    private boolean needsScrollBars() {
        ...
        return selectedTabIndex != CreativeTabs.INVENTORY.getTabIndex() &&
               ...
               ((GuiContainerCreativeOverride.ContainerCreative) this.inventorySlots).canScroll();
    }
            ...
            for (int i = 0; i < 5; ++i) {
                for (int j = 0; j < 9; ++j) {
                    this.addSlotToContainer(
                            new GuiContainerCreativeOverride.LockedSlot(GuiContainerCreativeOverride.basicInventory,
            ...
            for (int k = 0; k < 5; ++k) {
                for (int l = 0; l < 9; ++l) {
                    ...
                    if (i1 >= 0 && i1 < this.itemList.size()) {
                        ...
                        GuiContainerCreativeOverride.basicInventory
                                .setInventorySlotContents(l + k * 9, ItemStack.EMPTY);
                    }
                }
            }
        }
